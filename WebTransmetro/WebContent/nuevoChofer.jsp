			...
			<!-- <div class="main">
				<div class="indent-left">
					<div class="wrapper">-->
						<article class="col-1">
							<h3>Nuevo Chofer</h3>
							<form id="contact-form" name="catalogo-libros" method="post" action="ServletCrearChofer.do">
								<fieldset>
									<label>
									...
									<label>
										<input type='text' name='txtClave' value="Clave" onBlur="if(this.value=='') this.value='Clave'" onFocus="if(this.value =='Clave' ) this.value=''" id='clave' class='myBoxSmall'>
									</label>
									<label>
